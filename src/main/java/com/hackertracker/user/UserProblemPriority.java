...
@Entity
@Table(name="user_problem_priorities", indexes = {
        @Index(name = "idx_user_problem_priority_user", columnList = "user_id"),
        @Index(name = "idx_user_problem_priority_problem", columnList = "problem_id")
})
