...
//    private final UserProblemAttemptDAO userProblemAttemptDAO;
//
//    public UserProblemService(SessionFactory sessionFactory, ProblemDAO problemDAO, DTOMapper dtoMapper, UserProblemAttemptDAO userProblemAttemptDao, UserProblemAttemptDAO userProblemAttemptDAO) {
...
//    }
//
//    public void addProblemAttempt(Problem problem, User user, byte difficultyRating, Date startTime, Date endTime, String notes) {
//        userProblemAttemptDAO.saveAttempt(problem, user, difficultyRating, startTime, endTime, notes);
//    }
//
////    /**
...
//                            null,
//                            dtoMapper.toTagDtoList(mergedProblem.getListTags())
//                    );
//
