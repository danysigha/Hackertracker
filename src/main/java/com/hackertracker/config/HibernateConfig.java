...
public class HibernateConfig {
        ...
        public CacheManager jCacheManager() {
                ...
                javax.cache.configuration.Configuration<Object, Object> entityCacheConfig = Eh107Configuration
                ...
                javax.cache.configuration.Configuration<Object, Object> queryCacheConfig = Eh107Configuration
                                .fromEhcacheCacheConfiguration(
                                                CacheConfigurationBuilder.newCacheConfigurationBuilder(
                                                                Object.class, Object.class,
                                                                ResourcePoolsBuilder.newResourcePoolsBuilder()
                ...
                javax.cache.configuration.Configuration<Object, Object> timestampCacheConfig = Eh107Configuration
                                .fromEhcacheCacheConfiguration(
                                                CacheConfigurationBuilder.newCacheConfigurationBuilder(
                                                                Object.class, Object.class,
                                                                ResourcePoolsBuilder.newResourcePoolsBuilder()
        ...
        @Bean
        public SessionFactory sessionFactory(DataSource dataSource, CacheManager jCacheManager) {
                ...
                hibernateProps.put("hibernate.search.backend.analysis.configurer",
                                "com.hackertracker.config.MyLuceneAnalysisConfigurer");
                ...
                ServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder().applySettings(hibernateProps)
                                .build();
