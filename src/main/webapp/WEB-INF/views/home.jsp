...
//                let query = document.getElementById("bookInput").value;
//                if(query.length === 0){
//                    document.getElementById("suggestions").innerHTML = "";
//                    return;
//                }
//
//                let xhr = new XMLHttpRequest(); // can use xml, simplestrings or json
//                // read more about XMLHttpRequest states, onreadystatechange function
//                xhr.open("GET", "ajax.htm?query="+query, true); // true specifes async, you do NOT wait for data to show page
//                xhr.onreadystatechange = function () {
//                    if(xhr.readyState === 4 && xhr.status === 200){
//                        let suggestions = JSON.parse(xhr.responseText);
//                        let suggestionList = "";
//                        suggestions.forEach(book => {
//                            suggestionList += "<div class='suggestion' onclick='selectBooks(\"" + book.name + "\")'> " + book.name + "</div>";
//                        });
//
...
//                };
//
//                xhr.send(); // this is what acctually sends the request to the server
//            }
//
//            function selectBooks(bookName){
//                document.getElementById("bookInput").value = bookName;
//                document.getElementById("suggestions").innerHTML = "";
//            }

                $(document).ready( () => { // wait for the DOM to load completely
                    $("#bookInput").on("keyup", () => {
...
//                    $.post("search.htm", {query : query}, function (data){
//                        let suggestions = JSON.parse(data);
//                        let suggestionList = "";
//                        $.each(suggestions, function(index, book){
//                            suggestionList += "<div class='suggestion' onclick='selectBooks(\"" + book.name + "\")'> " + book.name + "</div>";
//                        });
//
